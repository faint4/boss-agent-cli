...
from boss_agent_cli.application.core_journey_contract import RECRUITING_CONTRACT
...
@click.option(
	"--input-json",
	default=RECRUITING_CONTRACT.default_payload_json,
	help=RECRUITING_CONTRACT.cli_option_help,
)
@click.pass_context
